  ...
  return (
    <div>
      ...
      <section className="first-section">
        <article className="first-article">
          <p className="first-para">
            ...
            through the Pinata web interface, an API endpoint, or through a Pinata SDK if the user
          ...
          <div className="image-1">
            <img src={image3} alt="Image showing step 1 of the process" />
          </div>
        </article>
      </section>
      ...
      <section className="second-section">
        <article className="second-article">
          ...
          <div className="image-2">
            <img src={image2} alt="Image showing step 2 of the process" />
          </div>
        </article>
      </section>
      ...
      <section className="third-section">
        <article className="third-article">
          ...
          <div className="image-3">
            <img src={image1} alt="Image showing step 3 of the process" />
          </div>
        </article>
      </section>
      ...
      <footer className="footer-section">
        ...
        <div className="column">
          <p className="Column3-text">© 2024 Blockstash. All rights reserved</p>
        </div>
      </footer>
    </div>
  );
