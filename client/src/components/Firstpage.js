  ...
  return (
    <div>
      ...
      <div className="animate-section">
        <h2 className="animate-heading">What is BlockStash ?</h2>
        <p className="animate-para">
          BlockStash is a decentralized file storage system that uses
          ...
          BlockStash, data management becomes decentralized and transparent, a
      ...
      <div className="about">
        ...
        <p className="about-text">
          At BlockStash, we believe that data ownership and privacy are
